...
class YieldForecastEstimatorTest {
    ...
    // base 4.0 t/ha, ndvi floor 0.2, optimal 0.8, chill min factor 0.6. Chill requirement 40 CP passed per call.
    ...
    void scalesYieldByVigorChillAdequacyAndArea() {
        ...
        var yield = estimator.estimate(0.62, 45.0, 40.0, 12.5);
    ...
    void appliesMinimumChillModifierWhenChillIsAbsent() {
        ...
        var yield = estimator.estimate(0.62, 0.0, 40.0, 10.0);
    ...
    void yieldsZeroWhenVigorIsAtOrBelowTheFloor() {
        var yield = estimator.estimate(0.15, 50.0, 40.0, 10.0);
    ...
    void capsVigorAndChillContributionsAtOptimum() {
        ...
        var yield = estimator.estimate(0.95, 100.0, 40.0, 5.0);
    ...
    @Test
    void lowerChillRequirementReachesAdequacySooner() {
        // chill 30 against requirement 30 -> full adequacy; modifier 1.0; 4.0*0.7*1.0*10 = 28.0
        var yield = estimator.estimate(0.62, 30.0, 30.0, 10.0);

        assertEquals(28.0, yield.getValue(), 1e-6);
    }
}
