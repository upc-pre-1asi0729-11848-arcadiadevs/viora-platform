package com.arcadiadevs.viora.platform.iam.infrastructure.authorization.sfs.configuration;

import com.arcadiadevs.viora.platform.iam.infrastructure.authorization.sfs.pipeline.BearerAuthorizationRequestFilter;
import com.arcadiadevs.viora.platform.iam.infrastructure.hashing.bcrypt.BCryptHashingService;
        ...
        http.csrf(csrfConfigurer -> csrfConfigurer.disable())
                ...
                .authorizeHttpRequests(authorizeRequests -> authorizeRequests
                        .requestMatchers(
                                ...
                                "/swagger-resources/**",
                                "/webjars/**").permitAll()
                        // .anyRequest().authenticated()); // TODO: Change back to authenticated() when security is fully enabled
